...
HoverOnTouch.prototype.mouseupHoverontouch = function (e) {
    ...
    if (object.getAttribute('data-link')) {
        if (debug) {console.log("clicked mouse");}
        // alert("mouse click");
...
HoverOnTouch.prototype.touchstartHoverontouch = function (e) {
    ...
    if (debug) {console.log("this.multipleTouchAmount: "+this.multipleTouchAmount);}

    if (this.multipleTouchAmount > 1) {
        this.multiTouchGesture = true;
        if (debug) {console.log("this.multiTouchGesture: "+this.multiTouchGesture);}
    }
    ...
    object.className += " hoverontouch--aktiv";
    if (debug) {console.log('e.changedTouches'+e.changedTouches[0]);}
    ...
    var self = this;
    if (debug) {console.log("timer runs");}
    this.pressTimer = window.setTimeout(function() {
        if (debug) {console.log("timer end, longpress detected");}
        self.longpress = true;
    },250);
...
HoverOnTouch.prototype.touchendHoverontouch = function (e) {
    ...
    this.multipleTouchAmount = this.multipleTouchAmount - 1;
    if (debug) {console.log("this.multipleTouchAmount: "+this.multipleTouchAmount);}
    if (debug) {console.log("this.longpress: "+this.longpress);}
    if (debug) {console.log("this.multiTouchGesture: "+this.multiTouchGesture);}
    ...
    if (!this.longpress && this.multiTouchGesture === false && this.multipleTouchAmount === 0) {
        ...
        // calculate Distance
        if (debug) {console.log('touchclick');}
        var distanceX = 0;
        var distanceY = 0;
